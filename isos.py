...
iso_images = {
    ...
    'sparky-07.02': {
        ...
        'iso': 'https://sourceforge.net/projects/sparkylinux/files/lxqt/sparkylinux-7.2-x86_64-lxqt.iso/download',
        'sums': 'https://sourceforge.net/projects/sparkylinux/files/lxqt/sparkylinux-7.2-x86_64-lxqt.iso.allsums.txt/download',
        'sign': 'https://sourceforge.net/projects/sparkylinux/files/lxqt/sparkylinux-7.2-x86_64-lxqt.iso.sig/download',
        'prints': [
            'DF9B9C49EAA9298432589D76DA87E80D6294BE9B'
        ],
        'keyserver': 'keyring.debian.org'
    ...
    'zorin-16.3': {
        ...
        'menu': 'debian-loop',
        'title': 'Zorin Desktop (16.03)'
    },
    'manjaro-23.0-230903': {
        'name': 'manjaro',
        'menu': 'manjaro',
        'title': 'Manjaro Desktop (23) Gnome',
